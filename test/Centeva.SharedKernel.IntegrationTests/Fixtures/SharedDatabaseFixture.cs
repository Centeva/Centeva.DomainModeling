...
{
    // Docker
    public const string ConnectionStringDocker = "Data Source=database;Initial Catalog=CentevaSharedKernelEFCoreTests;PersistSecurityInfo=True;User ID=sa;Password=Centeva1234!";

    // (localdb)
    public const string ConnectionStringLocalDb = "Server=(localdb)\\mssqllocaldb;Integrated Security=SSPI;Initial Catalog=CentevaSharedKernelEFCoreTests;ConnectRetryCount=0";
