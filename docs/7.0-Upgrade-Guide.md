...
the domain model of an application that is shared between multiple bounded
contexts.  This package is designed to provide basic building blocks for
...
not have been usable depending on how you implement integration events.  For
